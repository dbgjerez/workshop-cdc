...
public class MergeStrategy implements AggregationStrategy {
    ...
    public Exchange aggregate(Exchange original, Exchange resource) {
        ...
        if (userFromMongo != null) {
            ...
            if (userFromDebezium.getRemoteId() != null)
                userFromMongo.setRemoteId(userFromDebezium.getRemoteId());
            if (userFromDebezium.getDni() != null)
                userFromMongo.setDni(userFromDebezium.getDni());
            if (userFromDebezium.getFirstName() != null)
